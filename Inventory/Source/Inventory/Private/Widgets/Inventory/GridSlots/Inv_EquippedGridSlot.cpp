...
UInv_EquippedSlottedItem* UInv_EquippedGridSlot::OnItemEquipped(UInv_InventoryItem* Item, const FGameplayTag& EquipmentTag, float TileSize)
{
	...
	const FInv_GridFragment* GridFragment = GetFragment<FInv_GridFragment>(
		Item, FGameplayTag::RequestGameplayTag(TEXT("FragmentTags.GridFragment"), /* ErrorIfNotFound */ true));
	...
	const FInv_ImageFragment* ImageFragment = GetFragment<FInv_ImageFragment>(
		Item, FGameplayTag::RequestGameplayTag(TEXT("FragmentTags.IconFragment"), /* ErrorIfNotFound */ true));
