...
void UInv_HoverItem::UpdateHotbarIndex(int32 Index)
{
	HotbarIndex = Index;
	if (Index >= 0)
	{
		Text_HotbarIndex->SetVisibility(ESlateVisibility::Visible);
...
void UInv_HoverItem::UpdateEquippedBorder(bool bEquipped) const
{
	if (bEquipped)
	{
