...
# 状态：暂停中
- 项目已达到可游玩的 Alpha 版本，并获得 A-/A 成绩；在学术层面上已完成其目标。
- 由于人手变动，在学术提交之后，决定继续参与的成员人数不足以维持最初规划的系统深度。

未来可能会有一些小幅改进。  
不过由于 Git 的限制，更新不会反映在这个特定仓库中。
